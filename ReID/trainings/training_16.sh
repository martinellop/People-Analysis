...
#SBATCH --output=/homes/pmartinello/output_tr_16.txt
#SBATCH --error=/homes/pmartinello/error_tr_16.txt
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
...
--checkpoints_folder /work/cvcs_2022_group02/training_16/checkpoints
--results_folder /work/cvcs_2022_group02/training_16/results
