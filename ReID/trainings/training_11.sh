#!/bin/bash
#SBATCH --job-name=train11
#SBATCH --output=/homes/pmartinello/output_tr_11.txt
...
--checkpoints_folder /work/cvcs_2022_group02/training_11/checkpoints
--results_folder /work/cvcs_2022_group02/training_11/results
